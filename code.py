...
#tkinter elements
info_label = Label(root, text=password, bg="#949EFF", fg="#00CED1")
password_length_label = Label(root, text="Choose Password Length", bg="#949EFF", fg="#2A235D")
...
password_conditions_label = Label(root, text="Password Conditions",bg="#949EFF", fg="#2A235D", font=("Arial", 10, "bold"))
password_copied_message = Label(root, text="",bg="#949EFF", fg="#00CED1")

has_small_alpha_check = Checkbutton(root, text="Small Alphabets", variable=has_small_alpha, onvalue=1, offvalue=0, bg="#949EFF",fg="#1E1B51", borderwidth=5, font=("Arial", 8, "bold"))
has_big_alpha_check = Checkbutton(root, text="Big Alphabets", variable=has_big_alpha, onvalue=1, offvalue=0, bg="#949EFF",fg="#1E1B51", borderwidth=5, font=("Arial", 8, "bold"))
has_number_check = Checkbutton(root, text="Numbers", variable=has_number, onvalue=1, offvalue=0, bg="#949EFF",fg="#1E1B51", border=5, font=("Arial", 8, "bold"))
has_symbols_check = Checkbutton(root, text="Symbols", variable=has_symbol, onvalue=1, offvalue=0, bg="#949EFF",fg="#1E1B51", border=5, font=("Arial", 8, "bold"))
password_length_scale = Scale(root, from_=3, to=20, orient=HORIZONTAL, bg="#949EFF",fg="#1E1B51", troughcolor="#1E1B51")
...
center_window(root)
root.configure(background="#949EFF")
